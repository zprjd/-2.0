...
void insertNodebyhead2(struct userNode*headNode,struct userNode* tNode)				/*头插结点 不用遍历 */ 
{
...
void keydown1(struct Node* list,const char *filename){
	int choice = -1;
	fflush(stdin);
	scanf("%d",&choice);
